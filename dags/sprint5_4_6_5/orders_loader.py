...
class OrderLoader:
    ...
    WF_KEY = "ordersystem_order_origin_to_stg_workflow"
    LAST_LOADED_TS_KEY = "last_loaded_ts"
    # Restaurant
    def __init__(self, collection_loader: OrderReader, pg_dest: PgConnect, pg_saver: PgSaverOrdersystemOrders, logger: Logger) -> None:
