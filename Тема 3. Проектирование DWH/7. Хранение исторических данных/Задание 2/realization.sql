...
alter table public.products add column valid_from timestamptz not null default now();
...
alter table public.sales add constraint sales_proucts_id_fk foreign key (product_id) references public.products(id);